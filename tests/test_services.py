...
class TestMediaItemService:
    ...
    def test_get_all_items_no_filter(self):
        ...
        with patch(
            "src.media_picker.services.media_service.MediaItemRepository"
        ) as mock_repo_class:
    ...
    def test_spin_wheel_with_items(self):
        ...
        with (
            patch("src.media_picker.services.media_service.MediaItemRepository") as mock_repo_class,
            patch("src.media_picker.services.media_service.MediaItemFilter"),
